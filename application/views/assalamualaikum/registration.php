			...
			<div class="row">
				<div class="col-lg">
					<div class="p-5">
						...
						<form class="user" method="POST" action="<?php echo base_url('assalamualaikum/registration'); ?>">
						...
						<div class="text-center">
							<a class="small" href="<?php echo base_url('assalamualaikum') ?>">Already have an account? Login!</a>
						</div>
					</div>
				</div>
			</div>
